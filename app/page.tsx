...
export default function Home() {
  ...
  if (loading) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-linear-to-br from-indigo-500 via-purple-500 to-pink-500 text-white">
        Loading your themed experience...
      </div>
    );
  }
