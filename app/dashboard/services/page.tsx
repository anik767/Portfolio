                  ...
                  <div className="bg-white p-3 sm:p-4 rounded-lg sm:rounded-xl border border-gray-200">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-0 mb-2 sm:mb-3">
                      ...
                      <button
                        ...
                        className="px-2 sm:px-3 py-1 sm:py-1.5 bg-green-500 hover:bg-green-600 text-white rounded-lg text-xs sm:text-sm font-semibold shadow-md hover:shadow-lg transition-all duration-200 flex items-center gap-1"
                      >
                        <span>➕</span>
                    ...
                    {service.features.map((feature, featureIndex) => (
                      <div key={featureIndex} className="flex gap-2 mb-2">
                        ...
                        <button
                          ...
                          className="px-3 sm:px-4 py-1.5 sm:py-2 bg-red-500 hover:bg-red-600 text-white rounded-lg font-semibold shadow-md hover:shadow-lg transition-all duration-200 text-sm sm:text-base"
                        >
                          ×
                        </button>
                      </div>
                    ...
                    {service.features.length === 0 && (
                      <p className="text-gray-400 text-xs sm:text-sm text-center py-2">No features added yet</p>
                    )}
                  </div>
                </div>
              </div>
